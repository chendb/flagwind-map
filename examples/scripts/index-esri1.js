...
const baseUrl = "http://27.17.34.22:8081/arcgis4js/library/3.21/";
const moduleUrl = "http://27.17.34.22:8081/arcgis4js/library/3.21/init.js"; // "https://js.arcgis.com/3.21/";// 

import "./flagwind-map.less";
import {loadScript, loadModules, loadCss} from "esri-loader";
loadCss(`${baseUrl}esri/css/esri.css`);
loadCss(`${baseUrl}dijit/themes/claro/claro.css`);

loadScript({url: moduleUrl});
const options = {
...
loadModules([
    "dojo/parser", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/dom", "dojo/on", "dojo/fx",
    "dojox/gfx/fx", "dojox/gesture/tap",
    "./static/lib/heatmap-arcgis.js",
    ...
    "esri/layers/ArcGISImageServiceLayer", "esri/layers/GraphicsLayer", "esri/layers/DynamicMapServiceLayer", "esri/layers/ArcGISTiledMapServiceLayer", "esri/layers/WebTiledLayer",
...
function initMap(params) {
    ...
    var routeLayer = new flagwind.EsriVehicleRouteLayer(myMap, "car", {
        routeType: "NA",
        symbol: {
