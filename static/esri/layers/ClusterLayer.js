      ...
      return declare([GraphicsLayer], {
          constructor: function (options) {
              ...
              */
              ...
              this.creatGraphicByDevice = options.creatGraphicByDevice;
          ...
          _createSingle: function (single) {
            ...
            //   var graphic = this._graphics.find(g => g.attributes.id === single.id);
              var graphic = this._graphics.find(function (g) {
                  return g.attributes.id === single.id;
              });
              if (!graphic) {
                  var point = new Point(single[this.xPropertyName], single[this.yPropertyName], this.spatialRef);
                  var attributes = lang.clone(single);
                  graphic = new Graphic(point, null, attributes, null);
              }
        ...
        //   },
          ...
          _activateCluster: function (graphic) {
              ...
              for (i = 0, len = flareCount; i < len; i++) {
                  ...
                  if (tooltipText) flareGroup.rawNode.setAttribute("data-tooltip", tooltipText);
