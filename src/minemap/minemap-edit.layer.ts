...
namespace flagwind {
    ...
    export class MinemapEditLayer implements IFlagwindEditLayer {
        ...
        public registerEvent(graphic: MinemapMarker): void {
            ...
            graphic.on("onMouseUp", function (args: any) {
